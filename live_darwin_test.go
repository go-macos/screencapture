...
// captureDir, chooseCaptureDir and repoRootOf -- which decide where a capture
// may be written and, far more importantly, where it may NOT -- live in the
// UNTAGGED capturedir_test.go, so that CI runs the guard on every platform.
